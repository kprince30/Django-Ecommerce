...
<a class="navbar-brand" href="profile.jsp">ShopDF</a>
...
<ul class="navbar-nav mr-auto">
  ...
  <li class="nav-item">
      <a class="nav-link" href="contactus.jsp"><span class="fa fa-address-card"></span> Contact</a>
  </li>
  ...
  <ul class="navbar-nav mr-right">
   ...
   <div class="container-fluid p-0 m-0" >
       <div class="slide-banner-class " data-src style="display: block"><img  src="img/dryfruitbanner2.jpg">
       </div>
   </div>
       <!--end of banner-->
      <!--category section-->
...
<div class="modal-content">
    ...
    <h5 class="modal-title" id="exampleModalLabel">ShopDF</h5>
